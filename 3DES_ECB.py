...
#Al utilizar el modo ECB del algoritmo 3DES, los únicos parámetros obligatorios
#al momento de cifrar información son la información como tal y el modo. No es
#necesaria la utilización de vectores inicializadores, nounces, salt, rounds, etc.,
#y como el modo es constante, la única variable a modificar será la data que se quiera cifrar.

#variable correspondiente al mensaje a enviar
data = b'password'
while True:
    try:
